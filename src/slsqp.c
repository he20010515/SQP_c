/*... ./slsqp.f -- translated by f2c (version 20160102).
                            ...
                            integer *n3)
{
    ...
    extern /* Subroutine */ int slsqpb_(integer *, integer *, integer *,
                                        ...
                                        doublereal *, doublereal *, doublereal *, doublereal *, integer *, integer *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *,
                                        integer *, doublereal *, doublereal *, doublereal *, doublereal *,
    ...
    *n1 = *n + 1;
    ...
    iv = iu + *n1;
    iw = iv + *n1;
    slsqpb_(m, meq, la, n, &x[1], &xl[1], &xu[1], f, &c__[1], &g[1], &a[a_offset], acc, iter, mode, &w[ir], &w[il], &w[ix], &w[im], &w[is], &w[iu], &w[iv], &w[iw], &jw[1], alpha, f0, gs, h1, h2, h3, h4,
            t, t0, tol, iexact, incons, ireset, itermx, line, n1, n2, n3);
    return 0;
} /* slsqp_ */

/* Subroutine */ int slsqpb_(integer *m, integer *meq, integer *la, integer *n, doublereal *x, doublereal *xl, doublereal *xu, doublereal *f,
...
L240:
    *h3 = zero;
    ...
    if (((d__1 = *f - *f0, abs(d__1)) < *acc || dnrm2___(n, &s[1], &c__1) < *acc) && *h3 < *acc && !badlin && *f == *f)
    {
        *mode = 0;
    }
    else
...
L255:
    *h3 = zero;
    ...
    if (((d__1 = *f - *f0, abs(d__1)) < *tol || dnrm2___(n, &s[1], &c__1) < *tol) && *h3 < *tol && !badlin && *f == *f)
    {
        *mode = 0;
    }
    else
...
/* Subroutine */ int lsq_(integer *m, integer *meq, integer *n, integer *nl,
                          integer *la, doublereal *l, doublereal *g, doublereal *a, doublereal *b, doublereal *xl, doublereal *xu, doublereal *x, doublereal *y,
                          doublereal *w, integer *jw, integer *mode)
{
    ...
    extern /* Subroutine */ int lsei_(doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, integer *, integer *,
                                      integer *, integer *, integer *, integer *, integer *, doublereal *, doublereal *, doublereal *, integer *, integer *),
        bound_(
...
/* Subroutine */ int lsei_(doublereal *c__, doublereal *d__, doublereal *e,
                           doublereal *f, doublereal *g, doublereal *h__, integer *lc, integer *mc, integer *le, integer *me, integer *lg, integer *mg, integer *n,
                           doublereal *x, doublereal *xnrm, doublereal *w, integer *jw, integer *mode)
{
    /* Initialized data */
    ...
    static doublereal t;
    extern /* Subroutine */ int h12_(integer *, integer *, integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *,
                                     integer *, integer *);
    ...
    extern /* Subroutine */ int lsi_(doublereal *, doublereal *, doublereal *,
                                     ...
                                     integer *),
        hfti_(doublereal *, integer *, integer *, integer *,
...
/* Subroutine */ int lsi_(doublereal *e, doublereal *f, doublereal *g,
                          ...
                          integer *n, doublereal *x, doublereal *xnorm, doublereal *w, integer *jw, integer *mode)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int h12_(integer *, integer *, integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *,
                                     integer *, integer *),
        ldp_(doublereal *, integer *, integer *,
             integer *, doublereal *, doublereal *, doublereal *, doublereal *,
             integer *, integer *);
    ...
    *mode = 5;
    ...
    for (i__ = 1; i__ <= i__2; ++i__)
    {
        ...
        for (j = 1; j <= i__1; ++j)
        {
            ...
            /* L20: */
            i__3 = j - 1;
            g[i__ + j * g_dim1] = (g[i__ + j * g_dim1] - ddot_sl__(&i__3, &g[i__ + g_dim1], lg, &e[j * e_dim1 + 1], &c__1)) / e[j + j *
                                                                                                                                        e_dim1];
        }
        /* L30: */
...
/* Subroutine */ int nnls_(doublereal *a, integer *mda, integer *m, integer *n, doublereal *b, doublereal *x, doublereal *rnorm, doublereal *w,
...
/* Subroutine */ int hfti_(doublereal *a, integer *mda, integer *m, integer *n, doublereal *b, integer *mdb, integer *nb, doublereal *tau, integer *krank, doublereal *rnorm, doublereal *h__, doublereal *g, integer *ip)
{
    /* Initialized data */
...
L180:
    ...
    for (jb = 1; jb <= i__2; ++jb)
    {
        ...
        for (i__ = k; i__ >= 1; --i__)
        {
            ...
            /* L210: */
            i__1 = k - i__;
            b[i__ + jb * b_dim1] = (b[i__ + jb * b_dim1] - ddot_sl__(&i__1, &a[i__ + j * a_dim1], mda, &b[j + jb * b_dim1], &c__1)) /
                                   a[i__ + i__ * a_dim1];
        }
...
/* Subroutine */ int h12_(integer *mode, integer *lpivot, integer *l1,
                          integer *m, doublereal *u, integer *iue, doublereal *up, doublereal *c__, integer *ice, integer *icv, integer *ncv)
{
    /* Initialized data */
...
doublereal linmin_(integer *mode, doublereal *ax, doublereal *bx, doublereal *f, doublereal *tol)
{
    /* Initialized data */
...
L30:
    if (abs(p) >= (d__1 = q * r__, abs(d__1)) * .5 || p <= q * (a - x) || p >= q * (b - x))
    {
        goto L40;
    }
...
doublereal ddot_sl__(integer *n, doublereal *dx, integer *incx, doublereal *dy, integer *incy)
{
    /* System generated locals */
    integer i__1;
    doublereal ret_val;
